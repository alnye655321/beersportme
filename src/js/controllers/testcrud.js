angular.module('Beersportme.controllers.testcrud', [])
  .controller("testcrudController", function ($scope, $http, jsonFilter)
  {
    ...
    $scope.simpleGetCall = function (withSuccess) {
      var callURL = (withSuccess ? "http://node.nyedigital.com/api/v1/authors" : "invalid-url.php");
